...
class MainScr(Screen):
  def __init__(self, **kwargs):
      ...
      vl.add_widget(ScrButton(self, direction='down', goal='first', text="1",background_normal ="", background_color = (150/255,10/255,20/255,1)))
      vl.add_widget(ScrButton(self, direction='left', goal='second', text="2",background_normal ="", background_color = (150/255,10/255,20/255,1)))
      vl.add_widget(ScrButton(self, direction='up', goal='third', text="3",background_normal ="", background_color = (150/255,10/255,20/255,1)))
      vl.add_widget(ScrButton(self, direction='right', goal='fourth', text="4",background_normal ="", background_color = (150/255,10/255,20/255,1)))
      hl.add_widget(txt)
      hl.add_widget(vl)
      self.add_widget(hl)
